<!-- start hero -->
<div class="hero bg-gray-100 relative lg:h-[100vh] z-10">
    <div class="max-w-7xl mx-auto px-6 sm:px-6 py-12 lg:py-32 relative z-10">
        <div class="lg:flex lg:flex-row lg:flex-wrap pb-32">
            ...
            <div class="lg:flex lg:items-start lg:justify-start mt-1 pt-12">
                <div class="relative pb-[56.25%] lg:w-[400px] w-full">
                    <iframe class="absolute top-0 left-0 w-full h-full rounded-2xl shadow-md" width="560" height="315" src="https://www.youtube.com/embed/AW7ie2mmNiQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    <div class="absolute inset-0 top-[-38rem] sm:top-[-11rem] xl:top-[-21rem] 2xl:top-[-23rem] -mr-8 pointer-events-none flex sm:flex-col flex-row-reverse -mb-32">
