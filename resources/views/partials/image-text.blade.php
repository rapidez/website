<div class="mx-auto mb-12 flex max-w-7xl flex-col gap-20 px-6 md:mb-32 md:px-6 md:gap-28">
    <div class="grid items-center gap-x-60 gap-y-6 md:grid-cols-2">
        ...
        <div class="relative mr-[calc(100%-100vw)] max-md:ml-20">
            ...
            <div class="flex flex-col rounded-2xl drop-shadow-toolbar">
                ...
                <img src="/img/code.png" alt="" class="relative mr-auto h-[360px] rounded-b-2xl object-cover object-left-top md:h-[720px]" />
            </div>
        </div>
    </div>
    ...
    <div class="grid items-center gap-x-60 gap-y-6 md:grid-cols-2">
        <div class="order-last flex flex-col items-start">
            ...
            <div class="mt-16 flex flex-col gap-4 border-t pt-16">
                ...
                <a href="#" class="flex items-center gap-3">
                    <x-icon-rocket-sm class="h-5 text-gray-400" />
                    <span>
                        <strong class="text-heading">15</strong>
        ...
        <div class="relative max-md:ml-20 max-md:mr-[calc(100%-100vw)] md:ml-[calc(100%-100vw)]">
            ...
            <div class="flex flex-col rounded-2xl drop-shadow-toolbar">
                ...
                <video src="/img/ranzijn.mp4" loop autoplay muted class="relative max-md::mr-auto h-[360px] rounded-b-2xl object-cover object-left-top md:ml-auto md:h-[720px] md:object-right-top" />
            </div>
        </div>
    </div>
</div>
