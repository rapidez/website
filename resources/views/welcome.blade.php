...
<body x-data="{solutions_menu:false, mobile_menu:false}" class="min-h-screen flex flex-col flex-1 font-body overflow-x-hidden">
                ...
                <div class="pt-5 pb-6 px-5">
                    ...
                    <div class="mt-6">
                        <nav class="grid gap-y-8">
                            ...
                            <a href="http://docs.rapidez.io/" target="_blank" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
    ...
    <div class="hero bg-gray-100 relative md:h-[65vh] lg:h-[100vh] z-10">
        ...
        <div class="absolute inset-0 xl:top-[-19rem] 2xl:top-[-25rem] -mr-8 pointer-events-none">
            <img src="https://raw.githubusercontent.com/rapidez/art/master/r.svg" alt="Rapidez" class="max-w-[115rem] 2xl:max-w-[110rem] flex -mt-3 sm:-mt-32 sm:-mr-32 -mr-20 w-full ml-auto opacity-[.04]">
        </div>
    ...
    <div class="relative flex flex-col mb-32">
        <div class="max-w-7xl mx-auto px-6 sm:px-6 w-full z-10 relative">
            <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl text-center mb-0">
            ...
            <div class="mt-6 lg:mt-14 sm:text-lg -mx-6">
                <div class="flex flex-nowrap text-gray-400">
                    <div class="flex p-6 flex-1">
                        <div class="bg-gray-100 flex flex-1 p-6 items-center justify-center rounded-full">
                    ...
                    <div class="flex p-6 flex-1">
                        <div class="bg-gray-100 flex flex-1 p-6 items-center justify-center rounded-full">
                            <img src="https://rapidez.io/img/tailwind-css.svg" alt="Tailwind CSS" loading="lazy" class="h-8">
                        </div>
                    </div>
                </div>
                <div class="flex flex-nowrap text-gray-400">
                    ...
                    <div class="flex p-6 flex-1">
                        <div class="bg-gray-100 flex flex-1 p-6 items-center justify-center rounded-full">
                            <img src="https://rapidez.io/img/justbetter.svg" alt="JustBetter" loading="lazy" class="h-14">
                        </div>
                    </div>
                    <div class="flex p-6 flex-1">
                        <div class="bg-gray-100 flex flex-1 p-6 items-center justify-center rounded-full">
    ...
    <div class="usps relative z-10 mb-32 mt-6" id="features" >
        <div class="max-w-7xl mx-auto px-6 sm:px-6 w-full z-10 relative">
            ...
            <div class="flex flex-wrap sm:-mx-6 mt-6 lg:mt-24">
    ...
    <div class="relative z-10 bg-gray-100 pt-32" id="why-rapidez" >
        <div class="max-w-7xl mx-auto px-6 sm:px-6 w-full z-10 relative">
            ...
            <div class="flex flex-wrap sm:-mx-6 pb-32 pt-24">
                ...
                <div class="w-full sm:w-1/2 sm:px-6 mb-12">
                    ...
                    <p class="leading-normal text-primary-100 text-opacity-60 antialiased">No, you do not need te use it. You are completely free to use whatever you want. We like it so we used it for basic styling.</p>
                </div>
                <div class="w-full sm:w-1/2 sm:px-6 mb-12">
    ...
    <div class="-mt-32 relative z-20">
        <div class="max-w-7xl mx-auto py-12 px-4 mb-6 text-center">
    ...
    <!-- This example requires Tailwind CSS v2.0+ -->
    <footer class="bg-white border border-t border-gray-200">
