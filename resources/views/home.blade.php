...
@section('content')
    ...
    @include('partials.logos', [
        'id' => 'partners',
        'title' => ['Partners'],
        'subtitle' => 'Our awesome implementation and technology partners.<br><a href="mailto:info@rapidez.io" class="underline hover:no-underline">Contact us</a> to discuss the possibilities.',
        'logos' => [
